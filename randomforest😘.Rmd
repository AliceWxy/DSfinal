...
hyper_params <- list(
  ntrees = c(100, 200, 300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500),  # 树的数量
  stopping_rounds = c(1,2,3,4,5,6),
  max_depth = c(1,5,10, 20, 30,40,50,60),  # 树的最大深度
...
# 获取网格搜索结果
grid_results <- h2o.getGrid("rf_grid_6", sort_by = "r2", decreasing = FALSE)
