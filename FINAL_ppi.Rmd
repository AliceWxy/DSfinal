...
grid <- h2o.grid("deeplearning", grid_id = "nn4", 
...
# Get the result
grid_results <- h2o.getGrid("nn4", sort_by = "r2", decreasing = T) 
...
# Save the model
nn <- h2o.saveModel(nnmodel, path = "nn4", force = T)
```

```{r}
# Load the pre-trained model
model <- h2o.loadModel(file.path("nn4", best_model))
