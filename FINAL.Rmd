...
write.csv(pred.df.cpi, file = "/Users/wangyang/Downloads/文件/CUHK/S2/DS/final/yhat.csv")
```
...
write.csv(pred.df.ppi, file = "/Users/wangyang/Downloads/文件/CUHK/S2/DS/final/yhat.csv", append = T)
```
